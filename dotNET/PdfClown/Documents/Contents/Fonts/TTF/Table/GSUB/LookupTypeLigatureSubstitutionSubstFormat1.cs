...
namespace PdfClown.Documents.Contents.Fonts.TTF.Table.GSUB
{
     ...
     *
     */
    public class LookupTypeLigatureSubstitutionSubstFormat1 : LookupSubTable
    {
        ...
        {
            get => ligatureSetTables;
        }

        public override string ToString()
        {
            return $"{nameof(LookupTypeLigatureSubstitutionSubstFormat1)}[substFormat={SubstFormat}]";
        }
    }
}
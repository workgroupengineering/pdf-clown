...
namespace PdfClown.Objects
{
    public abstract class PdfObjectWrapper3 : PdfObjectWrapper
    {
        ...
        public PdfObjectWrapper3(PdfDirectObject baseObject)
        {
    ...
    public abstract class PdfObjectWrapper3<TDataObject> : PdfObjectWrapper3
      where TDataObject : PdfDataObject
    {
        ...
        ///every time available.</param>
        public PdfObjectWrapper3(PdfDirectObject baseObject) : base(baseObject)
        { }
        ...
        protected PdfObjectWrapper3(PdfDocument context, TDataObject baseDataObject)

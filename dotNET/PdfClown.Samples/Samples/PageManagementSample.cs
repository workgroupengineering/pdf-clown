...
namespace PdfClown.Samples.CLI
{
    ...
    public class PageManagementSample : Sample
    {
        ...
        public override void Run()
        {
            ...
            using var mainDocument = new PdfDocument(mainFilePath);
                ...
                case ActionEnum.PageAddition:
                    {
                        ...
                        using (var sourceDocument = new PdfDocument(sourceFilePath))
                        {
                            // Source page collection.
                            PdfPages sourcePages = sourceDocument.Pages;
                            // Source page count.
                ...
                case ActionEnum.PageExtraction:
                    {
                        ...
                        Serialize(targetDocument, action);
                    }
                    break;
                case ActionEnum.DocumentMerge:
                    {
                        ...
                        using (var sourceDocument = new PdfDocument(sourceFilePath))
                        {
                            ...
                            new PageManager(mainDocument).Add(sourceDocument);
                        }
                        // Serialize the main file!
                        Serialize(mainDocument, action);
                    }
                ...
                case ActionEnum.DocumentBurst:
                    {
                        ...
                        { Serialize(splitDocument, action, ++index); }
                    }
                    break;
                ...
                case ActionEnum.DocumentSplitOnMaximumFileSize:
                    {
                        ...
                        long maxDataSize;
                        {
                            long mainFileSize = new FileInfo(mainFilePath).Length;
                            int kbMaxDataSize;
                            do
                            {
                                try
        ...
        {
            var actions = Enum.GetValues<ActionEnum>();
        ...
        private void Serialize(PdfDocument document, ActionEnum action) => Serialize(document, action, null);

        /// <summary>Serializes the specified PDF file.</summary>
        /// <param name="document">File to serialize.</param>
        /// <param name="action">Generator.</param>
        /// <param name="index">File index.</param>
        private void Serialize(PdfDocument document, ActionEnum action, int? index) => Serialize(
              document,
    ...
    {
        public static string GetDescription(this PageManagementSample.ActionEnum value)
        {

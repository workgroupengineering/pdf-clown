...
namespace PdfClown.UI
{
    public static class DefaultSKStyles
    {
        ...
        public static readonly SKPaint PaintToolTipText = new() { Style = SKPaintStyle.StrokeAndFill, Color = SKColors.Black, TextSize = 14, IsAntialias = true };
        public static readonly SKPaint PaintToolTipHeadText = new() { Style = SKPaintStyle.StrokeAndFill, Color = SKColors.Black, TextSize = 12, IsAntialias = true, FakeBoldText = true };
